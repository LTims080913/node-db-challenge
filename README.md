...
- [ ] Why do tables need a `primary key`?
  ...
  Tables need a primary key in order to be able to identify them uniquely and allows foreign keys to connect to that specific item in the table

- [ ] What is the name given to a table column that references the primary key on another table.

  A foreign key is the name given to a table column that references the primary key from another table.

- [ ] What do we need in order to have a _many to many_ relationship between two tables.

  In order to have a many to many relationship between two tables, you need an additional table to connect the initial two. 
